...
void TetrominoController::rotate(std::shared_ptr<Tetromino> &tetromino, TetrisAction action)
{
...
void TetrominoController::setCanMove(std::shared_ptr<Tetromino> &tetromino, bool b)
{
    tetromino->canMove = b;
}
void TetrominoController::setLockedInPlace(std::shared_ptr<Tetromino> &tetromino, bool b)
{
    tetromino->lockedInPlace = b;
}

bool TetrominoController::canMove(const std::shared_ptr<Tetromino> &tetromino)
{
    return tetromino->canMove;
}

bool TetrominoController::isLockedInPlace(const std::shared_ptr<Tetromino> &tetromino)
{
    return tetromino->lockedInPlace;
}

void TetrominoController::transform(std::shared_ptr<Tetromino> &tetromino, TetrisAction action, bool forward)
{
